...
@Component({
  selector: "app-document-set-reports",
  templateUrl: "./document-set-reports.component.html",
  styleUrls: ["./document-set-reports.component.scss"],
})
export class DocumentSetReportsComponent implements OnInit {
  ...
  getExcelDocumentSet() {
    this.isLoading = true;
    this.reportService
      .getExcelReport(this.documentSearchDto)
      .subscribe((res: Blob) => {
